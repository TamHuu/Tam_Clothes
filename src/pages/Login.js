  ...
  <div className="flex shadow-md">
    ...
    <div className="flex flex-wrap content-center justify-center rounded-l-md bg-white" style={{width: '24rem', height: '32rem'}}>
      <div className="w-72">
        ...
        <form className="mt-4">
          <div className="mb-3">
            <label className="mb-2 block text-xs font-semibold text-start">Email</label>
          ...
          <div className="mb-3">
            <label className="mb-2 block text-xs font-semibold text-start">Password</label>
          ...
          <div className="mb-3 flex flex-wrap content-center">
            ...
            <a href="#22" className="text-xs font-semibold text-purple-700">Forgot password?</a>
          </div>
          ...
          <div className="mb-3">
            ...
            <button className="flex flex-wrap justify-center w-full border border-gray-300 hover:border-gray-500 px-2 py-1.5 rounded-md">
              <img alt='' className="w-5 mr-2" src="https://lh3.googleusercontent.com/COxitqgJr1sJnIDe8-jiKhxDx1FrYbtRHKJ9z_hELisAlapwE9LUPh6fcXIfb5vwpbMl4xl9H9TRFPc5NOO8Sb3VSgIBrfRYvW6cUA"/>
              Sign in with Google
            </button>
          </div>
        </form>
        ...
        <div className="text-center">
          ...
          <a href="#qq" className="text-xs font-semibold text-purple-700">Sign up</a>
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-wrap content-center justify-center rounded-r-md" style={{width: '24rem', height: '32rem'}}>
      <img alt='' className="w-full h-full bg-center bg-no-repeat bg-cover rounded-r-md" src="https://i.imgur.com/9l1A4OS.jpeg"/>
    </div>

  </div>

  <div className="mt-3 w-full">
      <p className="text-center">Made by <a href="https://www.instagram.com/_inubayuaji/" className="text-purple-700">Inu Bayu Aji</a> and ispired by <a  href="https://dribbble.com/shots/17564792-Log-in-page-Untitled-UI" className="text-purple-700">this</a>.</p>
  </div>
</div>
  )
}
